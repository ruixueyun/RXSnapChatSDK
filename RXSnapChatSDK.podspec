...
Pod::Spec.new do |s|
  s.name             = 'RXSnapChatSDK'
  s.version          = '3.0.5'
  s.summary          = 'ruixue RXSnapChatSDK framework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ruixueyun/RXSnapChatSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  #s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ruixue' => 'xingdonghai@weile.com' }
  s.source           = { :git => 'https://github.com/ruixueyun/RXSnapChatSDK.git', :tag => s.version.to_s }
